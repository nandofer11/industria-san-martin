...
async function sendEmail(req, res) {
  try {
    await sendgrid.send({
      to: "nandofer.11@hotmail.com", // Your email where you'll receive emails
      from: "nandofer.11@hotmail.com", // your website email address here
      subject: `[Lead from website] : ${req.body.asunto}`,
      ...
      <body>
        <div class="img-container" style="display: flex;justify-content: center;align-items: center;border-radius: 5px;overflow: hidden; font-family: 'helvetica', 'ui-sans';">              
              ...
              <h3>You've got a new mail from ${req.body.nombresCompleto}, their email is: ✉️${req.body.email}, ciudad: ${req.body.ciudad} </h3>
